package com.buenhijogames.chattemas.ui.mi_tema.temas.original
...
val esquemaModoOscuroOriginal = darkColorScheme(
    primary = primaryDark,
...
val esquemaModoClaroOriginal = lightColorScheme(
