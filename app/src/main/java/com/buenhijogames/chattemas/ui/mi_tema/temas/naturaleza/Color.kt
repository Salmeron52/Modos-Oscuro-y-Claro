package com.buenhijogames.chattemas.ui.mi_tema.temas.naturaleza
...
val esquemaModoOscuroNaturaleza = lightColorScheme(
...
val esquemaModoClaroNaturaleza = darkColorScheme(
    primary = primaryDark,
